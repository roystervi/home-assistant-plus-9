...
const navigation = [
  ...
  { id: "assistant", name: "Assistant", icon: Bot, component: Assistant },
  { id: "energy", name: "Energy", icon: Zap, component: EnergyMonitor },
  { id: "cameras", name: "Cameras", icon: Camera, component: Cameras },
  { id: "automations", name: "Automations", icon: Workflow, component: Automations },
  { id: "agenda", name: "Agenda", icon: Calendar, component: Agenda },
  { id: "medications", name: "Medications", icon: Pill, component: Medications },
  { id: "crypto", name: "Crypto", icon: Coins, component: CryptoPortfolio },
  { id: "thermostat", name: "Thermostat", icon: Thermometer, component: Thermostat },
  { id: "alarm", name: "Alarm", icon: Shield, component: AlarmPanel },
  { id: "sprinkler", name: "Sprinkler", icon: Sprout, component: SprinklerPage },
  { id: "media", name: "Media", icon: Music, component: MediaPage },
  { id: "system", name: "System", icon: Monitor, component: System },
